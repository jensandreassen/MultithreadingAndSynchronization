...
public class GUIMutex {
	...
	private void InitializeGUI()
	{
		...
		setStatus(Color.GRAY, "Testa input");
	}
	/**
	 * Updates list
	 * @param chr to update
	 */
	public void updateWriterLog(char chr) {
		listW.append("Wrote: " + chr + "\n");
	}
	/**
	 * Updates list
	 * @param chr to update
	 */
	public void updateReaderLog(char chr) {
		listR.append("Read: " + chr + "\n");
	}
	/**
	 * Updates transmitted text
	 * @param text
	 */
	public void updateTransmitted(String text) {
		lblTrans.setText(text);
	}
	/**
	 * updates reciewed text
	 * @param text
	 */
	public void updateRecieved(String text) {
		lblRec.setText(text);
		checklabels(text);
	}
	/**
	 * Sets status according to result
	 * @param text
	 */
	private void checklabels(String text) {
		if(text.equals(lblTrans.getText())) {
			setStatus(Color.GREEN, "Stämmer");
		} else {
			setStatus(Color.RED, "Stämmer inte");
		}
		btnClear.setEnabled(true);
	}
	/**
	 * sets status color and text
	 * @param color
	 * @param text
	 */
	...
	private class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			if (e.getSource() == btnRun) {
				if(bSync.isSelected()) {
					cont.transferSync(txtTrans.getText());
				} else {
					cont.transferASync(txtTrans.getText());
				}
				setStatus(Color.blue, "Jobbar");
